# -*- coding: utf-8 -*-
"""Copy of IEEECatboost.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1gLMRit6tYgoBZr70yii-PQXmVQfhknr2
"""
...
df_train1.to_csv('/content/drive/My Drive/Colab Notebooks/train1raw.csv', index=False)

df_test1.to_csv('/content/drive/My Drive/Colab Notebooks/test1raw.csv', index=False)

gc.collect()

df_train1=pd.read_csv('/content/drive/My Drive/Colab Notebooks/train1raw.csv')

df_test1=pd.read_csv('/content/drive/My Drive/Colab Notebooks/test1raw.csv')
gc.collect()
...
df_train1.ix[:,rfecv.support_].to_csv('/content/drive/My Drive/Colab Notebooks/rfecvdft1.csv', index=False)
